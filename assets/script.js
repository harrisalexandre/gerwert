...
$(document).ready(function () {
    ...
    const mostraMsgMes = (texto) => {
        ...
        switch (texto) {
            ...
            case "5/4": titulo = "05 de Abril de 2023"; mensagem = "<p>Foi o dia que decidimos deixar o outro aplicativo de lado e trocamos as primeiras mensagens pelo Whatsapp. Quase viramos a noite conversando nesse dia. hahaha</p>"; break;
            case "19/4": titulo = "19 de Abril de 2023"; mensagem = "<p>O dia que nos conhecemos presencialmente</p><p>Foi tão incrível, lembro como não conseguia formar uma frase. Fiquei sem voz e quando falava gaguejava. Estar tão perto de ti, ver que você é real. Que a mulher que sempre sonhei existe!</p>"; break;
            case "28/4": titulo = "28 de Abril de 2023"; mensagem = "<p>Foi o primeiro dia que saímos.<br>Você estava linda, usando sua blusa de bolinhas brancas.</p><p>Era seu primeiro show, e eu estava tão nervoso.</p><p>Mas logo esse nervosismo foi embora abrindo espaço pra um dos dias mais mágicos que já vivemos juntos.</p>"; break;

            case "19/5": titulo = "19 de Maio de 2023"; mensagem = "<p>Foi a primeira vez que fui te visitar.<br>ainda me lembro como perdi no caminho. hahahah.</p><p>Foi tão gostoso, a nenê se comportou até, gostamos muito da casa da Carol, de ir no Zagaia.</p><p>Poder conhecer seus amigos e seu lab, lugares que muito enchiam meus olhos ao te ver falar e poder partilhar disso, estar junto com você. ❤️ </p>"; break;
