...
$(document).ready(function () {
    ...
    const mostraMsgMes = (texto) => {
        ...
        switch (texto) {
            ...
            case "4/5": titulo = "4 de Maio de 2023"; mensagem = "<p>Dia do pedido de namoro!.</p><p>Fiquei o dia todo escrevendo, apagando e refazendo até que chegou a hora, às 23h30 deste dia te liguei, você ainda estava a casa da sua mãe, dormindo ao lado do JP, li e via teu olho enchendo, sua garganta querendo gritar quando terminei.</p><p>Foi o começo de tudo, não de tudo, mas do dia em que tornamos o que sonhamos pro futuro um pouco mais real. Te amo! ❤️</p>"; break;
